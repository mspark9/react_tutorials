...
const HeroSection = () => {
  return (
    <div className='hero-wrapper flex flex-col items-center mt-6'>
      ...
      <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, culpa! Non repellat quasi minus nihil perspiciatis blanditiis deleniti neque dicta optio esse, accusantium cumque at voluptas sed nobis eligendi sunt.</p>
